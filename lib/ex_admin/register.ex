defmodule ExAdmin.Register do
  ...
  defmacro register_resource(mod, [do: block]) do
    quote location: :keep do
      ...
      defstruct controller: @controller,
                ...
                index_filter_scopes: Module.get_attribute(__MODULE__, :index_filter_scopes),
  ...
  * an optional label: "Button Label" (shown above)
  ...
  defmacro filter_scopes(scopes_list) do
    quote do
      Module.put_attribute __MODULE__, :index_filter_scopes, unquote(scopes_list)
    end
  end
